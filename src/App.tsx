...
export const App = () => {
  ...
  const submit = () => {
    ...
    window.location.replace(
        "alfabank://sdui_screen?screenName=InvestmentLongread&fromCurrent=true&endpoint=v1/invest-main-screen-view/investment-longread/50349%3flocation=AM%26campaignCode=GH",
    );
